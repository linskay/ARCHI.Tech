...
const DatabaseConstraintErrorPage: React.FC = () => {
  return (
    <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'none' }}>
      <Paper elevation={6} sx={{
        ...
        <Typography variant="subtitle1" color="#e3f6fc" align="center" sx={{ mb: 4 }}>
          Операция не может быть выполнена из-за нарушения ограничений базы данных. Пожалуйста, проверьте введенные данные.
        </Typography>
...
export default DatabaseConstraintErrorPage; 