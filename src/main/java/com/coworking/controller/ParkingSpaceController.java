...
public class ParkingSpaceController {
    ...
    public ResponseEntity<ParkingSpaceDTO> getParkingSpaceById(
    ...
    public ResponseEntity<ParkingSpaceDTO> createParkingSpace(
        ...
        return ResponseEntity.status(201).body(parkingSpaceService.createParkingSpace(parkingSpaceDTO));
    }
    ...
    public ResponseEntity<ParkingSpaceDTO> updateParkingSpace(
            ...
            @RequestBody ParkingSpaceDTO parkingSpaceDTO) {
        return ResponseEntity.ok(parkingSpaceService.updateParkingSpace(parkingSpaceId, parkingSpaceDTO));
    }
