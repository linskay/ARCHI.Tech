    ...
    <Box sx={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: 'none' }}>
      <Paper elevation={6} sx={{
        ...
        <Box sx={{ display: 'flex', flexDirection: 'column', alignItems: 'center', mb: 3 }}>
          <CheckCircleIcon sx={{ fontSize: 72, color: '#00e676', mb: 2, animation: 'pop 0.7s cubic-bezier(.4,2,.6,1)' }} />
        </Box>
        ...
        <Typography variant="subtitle1" color="#e3f6fc" align="center" sx={{ mb: 4 }}>
          Ваше рабочее место забронировано. QR-код для входа будет доступен в личном кабинете.
        </Typography>
